...
`b_id` int(20) NOT NULL,
  ...
  `bicycle_availabaility` varchar(10) NOT NULL
...
INSERT INTO `bicycle` (`b_id`, `b_name`, `b_idfino`, `b_img`, `tube_price_per_hour`, `tubeless_price_per_hour`, `tube_price_per_day`, `tubeless_price_per_day`, `bicycle_availabaility`) VALUES
...
CREATE TABLE IF NOT EXISTS `rentedbicycle` (
`id` int(100) NOT NULL,
  `customer_username` varchar(50) NOT NULL,
  `b_id` int(20) NOT NULL,
  `rider_id` int(20) NOT NULL,
...
--
ALTER TABLE `bicycle`
 ADD PRIMARY KEY (`b_id`), ADD UNIQUE KEY `b_idfino` (`b_idfino`);

--
-- Indexes for table `clientcars`
--
ALTER TABLE `clientcars`
 ADD PRIMARY KEY (`b_id`), ADD KEY `client_username` (`client_username`);
...
--
ALTER TABLE `rider`
 ADD PRIMARY KEY (`rider_id`), ADD UNIQUE KEY `token_no` (`token_no`), ADD KEY `client_username` (`client_username`);

--
-- Indexes for table `rentedbicycle`
--
ALTER TABLE `rentedbicycle`
 ADD PRIMARY KEY (`id`), ADD KEY `customer_username` (`customer_username`), ADD KEY `b_id` (`b_id`), ADD KEY `rider_id` (`rider_id`);
