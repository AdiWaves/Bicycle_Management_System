    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Garagge <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="returnbicycle.php">Return Now</a></li>
...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.b_name, c.b_idfino, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type, d.rider_name, d.rider_phone FROM rentedbicycle rc, bicycle c, rider d WHERE id = '$id' AND c.b_id=rc.b_id AND d.rider_id = rc.rider_id";
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Bicycle:&nbsp;  <?php echo($b_name);?></h5>

           <h5> Bicycle Identification Number:&nbsp;  <?php echo($b_idfino);?></h5>
           ...
           <h5> Rider Name:&nbsp;  <?php echo($rider_name);?></h5>

           <h5> Rider Contact:&nbsp;  <?php echo($rider_phone);?></h5>
