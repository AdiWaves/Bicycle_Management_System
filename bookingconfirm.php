...
<?php
    ...
    $rider_id = $_POST['rider_id_from_dropdown'];
    $customer_username = $_SESSION["login_customer"];
    $b_id = $conn->real_escape_string($_POST['hidden_carid']);
    ...
    $sql0 = "SELECT * FROM bicycle WHERE b_id = '$b_id'";
    ...
    if (mysqli_num_rows($result0) > 0) {
        while($row0 = mysqli_fetch_assoc($result0)) {
            ...
            if($type == "ac" && $charge_type == "km"){
                $fare = $row0["tube_price_per_hour"];
            } else if ($type == "ac" && $charge_type == "days"){
                $fare = $row0["tube_price_per_day"];
            } else if ($type == "non_ac" && $charge_type == "km"){
                $fare = $row0["tubeless_price_per_hour"];
            } else if ($type == "non_ac" && $charge_type == "days"){
                $fare = $row0["tubeless_price_per_day"];
            } else {
                $fare = "NA";
            }
        }
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedbicycle(customer_username,b_id,rider_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $b_id . "','" . $rider_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
    $result1 = $conn->query($sql1);

    $sql2 = "UPDATE bicycle SET bicycle_availability = 'no' WHERE b_id = '$b_id'";
    $result2 = $conn->query($sql2);

    $sql3 = "UPDATE rider SET rider_consent = 'no' WHERE rider_id = '$rider_id'";
    $result3 = $conn->query($sql3);

    $sql4 = "SELECT * FROM  bicycle c, clients cl, rider d, rentedbicycle rc WHERE c.b_id = '$b_id' AND d.rider_id = '$rider_id' AND cl.client_username = d.client_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> My Ride <span class="caret"></span> </a>
                <ul class="dropdown-menu">
    ...
    <h2 class="text-center"> Thank you for using Bicycle Managment System! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                <h4> <strong>Bicycle Name: </strong> <?php echo $b_name; ?></h4>
                <br>
                <h4> <strong>Bicycle Identification number:</strong> <?php echo $b_idfino; ?></h4>
                <br>
                ...
                <?php } else {
                    ?>
                    <h4> <strong>Fare:</strong> Rs. <?php echo $fare; ?>/hour</h4>
                ...
                <br>
                <h4> <strong>Rider Name: </strong> <?php echo $rider_name; ?> </h4>
                <br>
                <h4> <strong>Rider Gender: </strong> <?php echo $rider_gender; ?> </h4>
                <br>
                <h4> <strong>Rider Token Number: </strong>  <?php echo $token_no; ?> </h4>
                <br>
                <h4> <strong>Rider Contact:</strong>  <?php echo $rider_phone; ?></h4>
                <br>
