...
$sql0 = "SELECT rc.id, rc.rent_end_date, rc.charge_type, rc.rent_start_date, c.b_name, c.b_idfino FROM rentedbicycle rc, bicycle c WHERE id = '$id' AND c.b_id = rc.b_id";
...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE rentedbicycle SET car_return_date='$car_return_date', no_of_days='$no_of_days', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE rentedbicycle SET car_return_date='$car_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE bicycle c, rider d, rentedbicycle rc SET c.bicycle_availability='yes', d.rider_consent='yes' 
     WHERE rc.rider_id=c.rider_id AND rc.rider_id=d.rider_id AND rc.customer_username = '$login_customer' AND rc.id = '$id'";
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Bicycle Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Bicycle Rentals! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Identification Number:</strong> <?php echo $b_idfino; ?></h4>
                <br>
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Bicycle Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Bicycle Rentals</h5>
                </div>
            </div>
        </div>
    </footer>
